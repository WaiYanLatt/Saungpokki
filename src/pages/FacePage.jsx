...
export default function FacePage() {
  const cardData = [
    ...
    {
      id: 5,
      name: "Young Adult Learner (Prelim)",
      age: "14 to 19 years",
      modules: "2 Modules",
      months: "5 months",
      color: "#f7d9ea",
      ...
      marginLeft: "20px",
      bgcolor2: "#f7e1ed",
      url: "/src/assets/img/com.webp",
      dis: "Basic English for Starters",
    },
    {
      id: 6,
      name: "Adult Learner (Prelim)",
      age: "20 years & above",
      modules: "2 Modules",
      months: "5 months",
      color: "#f0ddc9",
      ...
      marginLeft: "7px",
      bgcolor2: "#f0e1d7",
      url: "/src/assets/img/comman.webp",
      dis: "Basic English for Starters",
    },
  ];

  return (
    <div className="container-fluid px-28 min-h-[230vh] pt-28">
      <Link to="/product">
